...
このDirectoryのCertificateは、記録された`commit`、Coverage Epoch、Authority Lock、Core Policy、Evidence Setに対する過去のbounded判定です。現在のDefinitive状態やfeature branchの完成を示しません。
