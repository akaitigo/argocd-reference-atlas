...
3. Definitiveの細粒度Surfaceは`definitive/surface-inventory.yaml`で確認します。Targetが`partial`または`missing`なら`definitive/gap-ledger.yaml`のScenarioを返し、広いTarget名だけでclosureを判断しません。
