...
- 10 Scenarioのoffline Evidence integration Auditと、現行100 Surface × 10 Scenarioの1,000専用Proof row。統合結果をBehavior固有Proofへ流用せず、Authority atomic binding／Completion eligibleは0
