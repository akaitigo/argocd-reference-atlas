...
def input_specs() -> list[dict[str, Any]]:
    ...
    specs = [
        ...
        ("harness.scenario-runtime.security-004", "harness", ["scripts/scenarios/run_security_004.py", "scripts/scenarios/run_application_sync_policy_normal.py", "scripts/build-local-source.sh", "scripts/generate_scenario_proofs.py", "scripts/validate_scenario_proofs.py", "scripts/lib/atomic_evidence_publish.py", "scripts/test_security_004_preflight.py", "definitive/scenario-variant-contract.yaml", "fixtures/scenarios/security-004/workload/configmap.yaml", "fixtures/scenarios/security-004/cluster-secret.yaml", "fixtures/scenarios/security-004/duck-resources.yaml", "fixtures/scenarios/security-004/git-directory/approved/configmap.yaml", "fixtures/scenarios/security-004/git-directory/restricted/configmap.yaml"]),
