...
def main() -> None:
    ...
    if scenario_summary.get("variant_denominators_exhaustive") != 0 or scenario_summary.get("dedicated_runtime_reports") != 13 or scenario_summary.get("dedicated_runtime_execution_complete_rows") != 13:
