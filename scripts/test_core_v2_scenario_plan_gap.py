...
def validate(document: dict) -> None:
    ...
    if denominator["rows"] != 1000 or denominator["remaining_rows"] != 991 or denominator["scenario_gaps_open"] != 1000:
        raise ValueError("Scenario denominator retreated")
    if gaps["authority_atomic_rows"] != 0 or gaps["approved_variant_denominators"] != 0 or gaps["dedicated_runtime_reports"] != 9 or gaps["dedicated_runtime_execution_complete_rows"] != 9:
